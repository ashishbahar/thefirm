  ...
  return (
    <footer>
      <Container className=" custom_container">
        ...
        <ul className="d-flex ps-0 justify-content-between align-items-center flex-sm-row  flex-wrap footer_ul_width m-auto my-lg-5 pt-2 ">
          <li className="mx-xl-4 mx-3 mt-lg-0 mt-3">
            <a
        ...
        <div className=" footer_social_icon my-3  d-flex m-auto justify-content-between">
          <div>
            <a href="#" className="social_icon_hover">
              {" "}
              <svg
                width="10"
                height="20"
        ...
        <p className=" ff_nunito fw-normal py-lg-4 py-3 fs_sm color_lightgrey text-center letter_spacing_2_6">
